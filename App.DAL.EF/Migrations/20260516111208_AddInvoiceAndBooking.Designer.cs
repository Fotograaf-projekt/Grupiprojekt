...
namespace App.DAL.EF.Migrations
{
    ...
    [Migration("20260516111208_AddInvoiceAndBooking")]
    partial class AddInvoiceAndBooking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Domain.Album", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("App.Domain.Availability", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("App.Domain.ContactMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("App.Domain.Photographer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("App.Domain.SocialLink", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("App.Domain.Album", b =>
                {
                    ...
                    b.HasOne("App.Domain.Photographer", "Photographer")
                        .WithMany()
            ...
            modelBuilder.Entity("App.Domain.Invoice", b =>
                {
                    b.HasOne("App.Domain.Booking", "Booking")
                        .WithOne("Invoice")
                        .HasForeignKey("App.Domain.Invoice", "BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("App.Domain.Photo", b =>
                {
                    b.HasOne("App.Domain.Album", "Album")
                        .WithMany("Photos")
